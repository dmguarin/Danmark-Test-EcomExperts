...
export declare function Collapsible({ id, expandOnPrint, open, transition, preventMeasuringOnChildrenUpdate: _preventMeasuringOnChildrenUpdate, children, }: CollapsibleProps): JSX.Element;
export {};
