...
.Polaris-CheckableButton_1a7z5.Polaris-CheckableButton__CheckableButton--measuring_bwpnw { font-size: 0.9375rem; font-weight: var(--p-font-weight-bold); }

.Polaris-CheckableButton_1a7z5.Polaris-CheckableButton__CheckableButton--measuring_bwpnw::before { content: ''; display: inline-block; width: 0.9375rem; }

@media (min-width: 30.625em) { .Polaris-CheckableButton_1a7z5 { flex: 0 1 auto; } }
...
.Polaris-CheckableButton__Checkbox_1d6zr { pointer-events: none; height: var(--p-choice-size); width: var(--p-choice-size); margin-left: calc(var(--p-space-2)*-1 - var(--p-control-border-width)); }

.Polaris-CheckableButton__CheckableButton--selectMode_1hja7 .Polaris-CheckableButton__Checkbox_1d6zr { margin-left: calc(var(--p-space-2)*-1 - var(--p-control-border-width) - var(--p-border-width-1)); }
