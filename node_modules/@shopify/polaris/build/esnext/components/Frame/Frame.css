...
@media (min-width: 48em) { .Polaris-Frame_2qi9y { width: calc(100% - var(--pc-frame-offset)); margin-left: var(--pc-frame-offset); } }
...
@media (min-width: 48em) { .Polaris-Frame__TopBar_z6tf9 { left: var(--pc-frame-offset); width: calc(100% - var(--pc-frame-offset)); } }

.Polaris-Frame__ContextualSaveBar_14m7v { position: fixed; z-index: var(--p-z-5); top: 0; left: 0; width: 100%; }

@media (min-width: 48em) { .Polaris-Frame__ContextualSaveBar_14m7v { left: var(--pc-frame-offset); width: calc(100% - var(--pc-frame-offset)); } }
