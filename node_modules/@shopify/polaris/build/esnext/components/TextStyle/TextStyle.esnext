...
import styles from './TextStyle.scss.esnext';
...
function TextStyle({
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    console.warn('Deprecation: The `TextStyle` component has been deprecated. Use the `Text` component instead. See the Polaris component guide on how to use `Text`. https://polaris.shopify.com/components/text');
  }
