@charset "UTF-8";
:root { --polaris-version-number: '10.12.0'; }
...
.Polaris-Text--headingLg { font-size: var(--p-font-size-200); line-height: var(--p-font-line-height-2); }

@media (min-width: 48em) { .Polaris-Text--headingLg { font-size: var(--p-font-size-300); line-height: var(--p-font-line-height-3); } }

.Polaris-Text--headingXl { font-size: var(--p-font-size-300); line-height: var(--p-font-line-height-3); }

@media (min-width: 48em) { .Polaris-Text--headingXl { font-size: var(--p-font-size-400); line-height: var(--p-font-line-height-4); } }

.Polaris-Text--heading2xl { font-size: var(--p-font-size-300); line-height: var(--p-font-line-height-3); }

@media (min-width: 48em) { .Polaris-Text--heading2xl { font-size: var(--p-font-size-500); line-height: var(--p-font-line-height-5); } }

.Polaris-Text--heading3xl { font-size: var(--p-font-size-400); line-height: var(--p-font-line-height-4); }

@media (min-width: 48em) { .Polaris-Text--heading3xl { font-size: var(--p-font-size-600); line-height: var(--p-font-line-height-6); } }

.Polaris-Text--heading4xl { font-size: var(--p-font-size-600); line-height: var(--p-font-line-height-6); }
...
.Polaris-Badge { --pc-badge-horizontal-padding: var(--p-space-2); --pc-badge-vertical-padding: var(--p-space-05); display: inline-flex; align-items: center; padding: var(--pc-badge-vertical-padding) var(--pc-badge-horizontal-padding); background-color: var(--p-surface-neutral); border-radius: var(--p-border-radius-5); }
...
.Polaris-ActionList__Section:not(:first-child) { border-top: var(--p-border-divider); }

.Polaris-ActionList__Section:not(:first-child) > .Polaris-ActionList__Section--withoutTitle .Polaris-ActionList__Actions { padding-top: var(--p-space-2); }

.Polaris-ActionList__Actions { outline: none; list-style: none; margin: 0; padding: var(--p-space-2); }

.Polaris-ActionList > .Polaris-ActionList__Section--withoutTitle .Polaris-ActionList__Actions, .Polaris-ActionList__Section:first-child > .Polaris-ActionList__Section--withoutTitle .Polaris-ActionList__Actions { border-top: none; padding-top: var(--p-space-2); }

.Polaris-ActionList .Polaris-ActionList__Section .Polaris-ActionList__Actions { padding-top: 0; }
...
.Polaris-Box { --pc-box-shadow: initial; --pc-box-background: initial; --pc-box-border-radius: initial; --pc-box-border-radius-end-start: initial; --pc-box-border-radius-end-end: initial; --pc-box-border-radius-start-start: initial; --pc-box-border-radius-start-end: initial; --pc-box-border: initial; --pc-box-border-block-end: initial; --pc-box-border-inline-start: initial; --pc-box-border-inline-end: initial; --pc-box-border-block-start: initial; --pc-box-color: initial; --pc-box-min-height: initial; --pc-box-min-width: initial; --pc-box-max-width: initial; --pc-box-overflow-x: initial; --pc-box-overflow-y: initial; --pc-box-padding: initial; --pc-box-padding-block-end: initial; --pc-box-padding-inline-start: initial; --pc-box-padding-inline-end: initial; --pc-box-padding-block-start: initial; --pc-box-width: initial; --pc-box-border-width: var(--p-border-width-1); background-color: var(--pc-box-background); box-shadow: var(--pc-box-shadow); border-radius: var(--pc-box-border-radius); border-end-start-radius: var(--pc-box-border-radius-end-start, var(--pc-box-border-radius)); border-end-end-radius: var(--pc-box-border-radius-end-end, var(--pc-box-border-radius)); border-start-start-radius: var(--pc-box-border-radius-start-start, var(--pc-box-border-radius)); border-start-end-radius: var(--pc-box-border-radius-start-end, var(--pc-box-border-radius)); border-block-end: var(--pc-box-border-block-end, var(--pc-box-border)); border-inline-start: var(--pc-box-border-inline-start, var(--pc-box-border)); border-inline-end: var(--pc-box-border-inline-end, var(--pc-box-border)); border-block-start: var(--pc-box-border-block-start, var(--pc-box-border)); border-block-start-width: var(--pc-box-border-block-start-width, var(--pc-box-border-width)); border-block-end-width: var(--pc-box-border-block-end-width, var(--pc-box-border-width)); border-inline-start-width: var(--pc-box-border-inline-start-width, var(--pc-box-border-width)); border-inline-end-width: var(--pc-box-border-inline-end-width, var(--pc-box-border-width)); color: var(--pc-box-color); min-height: var(--pc-box-min-height); min-width: var(--pc-box-min-width); max-width: var(--pc-box-max-width); overflow-x: var(--pc-box-overflow-x); overflow-y: var(--pc-box-overflow-y); padding-block-end: var(--pc-box-padding-block-end, var(--pc-box-padding)); padding-inline-start: var(--pc-box-padding-inline-start, var(--pc-box-padding)); padding-inline-end: var(--pc-box-padding-inline-end, var(--pc-box-padding)); padding-block-start: var(--pc-box-padding-block-start, var(--pc-box-padding)); width: var(--pc-box-width); -webkit-overflow-scrolling: touch; }
...
.Polaris-AlphaStack { --pc-stack-spacing-xs: var(--p-space-4); --pc-stack-spacing-sm: var(--pc-stack-spacing-xs); --pc-stack-spacing-md: var(--pc-stack-spacing-sm); --pc-stack-spacing-lg: var(--pc-stack-spacing-md); --pc-stack-spacing-xl: var(--pc-stack-spacing-lg); display: flex; flex-direction: column; align-items: var(--pc-stack-align); gap: var(--pc-stack-spacing-xs); }

@media (min-width: 30.625em) { .Polaris-AlphaStack { gap: var(--pc-stack-spacing-sm); } }

@media (min-width: 48em) { .Polaris-AlphaStack { gap: var(--pc-stack-spacing-md); } }

@media (min-width: 65em) { .Polaris-AlphaStack { gap: var(--pc-stack-spacing-lg); } }

@media (min-width: 90em) { .Polaris-AlphaStack { gap: var(--pc-stack-spacing-xl); } }
...
.Polaris-CheckableButton { font-size: var(--p-font-size-100); font-weight: var(--p-font-weight-medium); line-height: var(--p-font-line-height-1); text-transform: initial; letter-spacing: initial; display: flex; align-items: center; min-height: 2.25rem; min-width: 2.25rem; margin: 0; padding: calc((2.25rem - var(--p-font-line-height-2) - var(--p-space-05))/2) var(--p-space-4); cursor: pointer; -webkit-user-select: none; user-select: none; text-decoration: none; text-align: left; border-radius: var(--p-border-radius-1); width: 100%; background: var(--p-surface); box-shadow: var(--p-shadow-button); border: var(--p-border-width-1) solid var(--p-border-neutral-subdued); border-top-color: var(--p-border-subdued); border-bottom-color: var(--p-border-shadow-subdued); }
...
.Polaris-ChoiceList__Title { display: block; margin: 0 0 var(--p-space-1); padding: 0; }
...
.Polaris-EmptyState--withinContentContainer .Polaris-EmptyState__Content { padding-bottom: var(--p-space-2); }
...
.Polaris-EmptyState__Content { padding-bottom: var(--p-space-2); }
...
.Polaris-Inline { display: flex; gap: var(--pc-inline-spacing); flex-wrap: var(--pc-inline-wrap); align-items: var(--pc-inline-block-align); justify-content: var(--pc-inline-align); }


.Polaris-Frame-Toast { display: inline-flex; max-width: 31.25rem; padding: var(--p-space-2) var(--p-space-4); border-radius: var(--p-border-radius-2); background: var(--p-surface-dark); color: var(--p-text-on-dark); margin-bottom: var(--p-space-5); }
...
@media (min-width: 48em) { .Polaris-Frame-Toast__CloseButton { align-self: flex-start; margin: calc(var(--p-space-2)*-1) calc(var(--p-space-4)*-1) calc(var(--p-space-2)*-1) 0; padding: var(--p-space-2) var(--p-space-4) 0; } }
...
.Polaris-Modal-Header__Title { word-wrap: break-word; word-break: break-word; overflow-wrap: break-word; flex: 1 1; align-self: center; }
...
.Polaris-IndexTable { --pc-index-table-translate-offset: 2.1875rem; --pc-index-table-table-header-offset: 2.1875rem; --pc-index-table-cell: 1; --pc-index-table-sticky-cell: 31; --pc-index-table-scroll-bar: 35; --pc-index-table-bulk-actions: 36; --pc-index-table-loading-panel: 37; position: relative; overflow: hidden; border-radius: inherit; }
...
.Polaris-OptionList > *:not(:first-child) { margin-top: var(--p-space-2); }
...
.Polaris-SkeletonPage__TitleAndPrimaryAction { display: flex; align-items: flex-start; }
